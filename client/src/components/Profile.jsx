  ...
  return (
    <div className="bg-gradient-to-r from-[#1E1E2F] to-[#3A2B4A] min-h-screen py-10">
      ...
      <div className="max-w-lg mx-auto p-8 sm:p-10 rounded-2xl shadow-2xl bg-[#28293D]">
        {/* Profile Heading */}
        <h2 className="text-3xl font-extralight text-teal-400 mb-8 text-center">Your Profile</h2>
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center text-gray-300">
            ...
            <div className="text-light text-gray-200">{user.name}</div>
          </div>
          <div className="flex justify-between items-center text-gray-300">
            <div className="font-normal">Email:</div>
            <div className="text-light text-gray-200">{user.email}</div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <button
            className="px-6 py-2 bg-teal-600 hover:bg-teal-500 rounded-lg text-base font-medium text-gray-100 shadow-md transition duration-200 ease-in-out"
